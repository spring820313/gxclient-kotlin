...
class ECSignatureProvider private constructor(
    ...
    private val eosPrivateKey: GxcPrivateKey,
    ...
    companion object {
        ...
        fun sign(hash: ByteArray, eosPrivateKey: GxcPrivateKey): ECSignatureResult {
            return ECSignatureProvider(hash, eosPrivateKey).generate()
        }

        private fun setRecId(hash: ByteArray, eosPrivateKey: GxcPrivateKey, signature: ECKey.ECDSASignature): ECSignatureResult {
        ...
        private fun recoverPubKey(keyCurve: SecP256K1KeyCurve, messageSigned: ByteArray, signature: ECKey.ECDSASignature, recId: Int): GxcPublicKey? {
